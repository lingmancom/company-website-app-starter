  ...
  <div class="p-10">
    <el-table v-loading="loading" :data="tableData" stripe height="700" border>
      ...
      <el-table-column v-slot="{ row }" label="操作">
        <el-button type="primary" @click="(dialogVisible = true, Object.assign(item, row))"> 编辑 </el-button>
    ...
    <el-dialog v-model="dialogVisible" title="">
      ...
      <template #footer>
        <div class="dialog-footer">
          <el-button @click="(dialogVisible = false, Object.assign(item, generateItem()))">取 消</el-button>
